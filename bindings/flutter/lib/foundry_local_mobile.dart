...
///
/// This package is a `dart:ffi` plugin over the Foundry Local Mobile C++ core,
/// which loads local ONNX Runtime GenAI models directly (no Microsoft Foundry
/// Local runtime, catalog or download dependency). It runs entirely on the
/// device; there is no backend, no per-token cost and no network required for
/// inference.
///
